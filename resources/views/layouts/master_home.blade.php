...
<head>
  ...
  <link href="{{ asset('frontend/assets/vendor/venobox/venobox.css') }}assets/vendor/venobox/venobox.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html"><span>C-</span>SCHOOL</a></h1>
